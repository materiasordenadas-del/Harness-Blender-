...
def test_reference_plan_reuses_known_asset_and_routes_unknown_asset_to_review(tmp_path):
    ...
    observations = [
        {"observation_id": "o1", "visual_category": "ion_channel", "domain": "apical", "anchor": "apical:u=0.3", "bounds": [0, 0, 2, 1], "confidence": 0.95, "asset_id": "aqp2"},
        {"observation_id": "o2", "visual_category": "receptor", "domain": "basal", "anchor": "basal:u=0.6", "bounds": [3, 0, 2, 1], "confidence": 0.95, "asset_id": "unknown"},
    ]
...
def test_low_confidence_reference_element_is_not_assigned_a_canonical_identity(tmp_path):
    ...
    plan = build_reconstruction_plan(
        reference,
        [{"observation_id": "o1", "visual_category": "ion", "domain": "cytoplasm", "anchor": "cytoplasm:center", "bounds": [0, 0, 1, 1], "confidence": 0.5, "asset_id": None}],
        {},
