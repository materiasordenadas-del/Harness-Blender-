...
def create_cell2d_symbol(
    object_name: str, asset_id: str | None, visual_category: str, domain: str, anchor: str, bounds: list[float],
    ...
    return _run("create_cell2d_symbol", {
        ...
        "domain": domain, "anchor": anchor, "bounds": bounds, "shape_family": shape_family, "material": material,
